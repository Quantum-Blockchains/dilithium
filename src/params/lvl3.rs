...
pub const TAU: i32 = 49; //number of +-1s in c
pub const CHALLENGE_ENTROPY: i32 = 225;
pub const GAMMA1: i32 = 1 << 19; //y coefficient range
pub const GAMMA2: i32 = (crate::params::Q - 1) / 32; //low-order rounding range
pub const K: i32 = 6; //rows in A
pub const L: i32 = 5; //columns in A
pub const ETA: i32 = 4;
...
pub const POLYETA_PACKEDBYTES: i32 = 96;
